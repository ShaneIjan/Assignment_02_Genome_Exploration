...
**Figure 3.** Result of the Filter Sequences by Length tool applied to the *Canis lupus* genome assembly in Galaxy. The resulting FASTA dataset contains 82 sequences.
...
**Figure 4.** Result of the Filter FASTA tool used to select the *Canis lupus* sequence CAJNRB020000009.1 for ORF analysis. One sequence was retained while 81 sequences were discarded.

<img width="1744" height="1071" alt="image" src="https://github.com/user-attachments/assets/6b21812e-76ed-482b-987a-c2f7e7c5bd61" />

**Figure 5.** Output of the getorf tool showing predicted open reading frames (ORFs) from the selected *Canis lupus* sequence. A total of 206 ORFs were identified, with the longest ORF (CAJNRB020000009.1_15) having a length of 3,441 bp.
...
The important Galaxy analysis screenshots are available in the `screenshots/` folder. It includes documentation of the main steps, including Fasta Statistics, sequence length calculation, filtering, and ORF identification.
